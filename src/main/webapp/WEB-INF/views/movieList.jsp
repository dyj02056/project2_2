...
<body>
    <h1 class="heading">Box Office Movies</h1>
    ...
    <div class="container">
        ...
        %>
                            ...
                            <div class="movie-info">
                                <p class="movie-rank">순위: <%=rank %></p>
                                <p class="movie-sales-share">매출 점유율: <%=salesShare %> %</p>
                                <p class="movie-release-date">개봉일: <%=releaseDate %></p> 
                            </div>
                        </div>
        <%
                }
